...
def test_case_3():
    ...
    assert (
        f"{type(node_3).__module__}.{type(node_3).__qualname__}" == "linkedList3.Node"
    )
...
def test_case_4():
    ...
    node_0 = singly_linked_list_0.getHeadNode()
    assert (
        f"{type(node_0).__module__}.{type(node_0).__qualname__}" == "linkedList3.Node"
    )
...
def test_case_7():
    ...
    assert (
        f"{type(node_1).__module__}.{type(node_1).__qualname__}" == "linkedList3.Node"
    )
    ...
    assert (
        f"{type(node_2).__module__}.{type(node_2).__qualname__}" == "linkedList3.Node"
    )
