...
def test_case_13():
    ...
    var_2.insert_to_front(var_2)


@pytest.mark.xfail(strict=True)
def test_case_14():
    none_type_0 = None
    none_type_0.insert_to_front(none_type_0)
