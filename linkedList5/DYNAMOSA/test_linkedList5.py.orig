...
def test_case_17():
    ...
    bool_0 = False
    linked_list_0 = module_0.LinkedList(bool_0)
    linked_list_0.delete_alt(tuple_0)
...
def test_case_30():
    ...
    assert (
        f"{type(var_15).__module__}.{type(var_15).__qualname__}" == "linkedList5.Node"
    )
...
def test_case_34():
    ...
    assert (
        f"{type(var_15.next).__module__}.{type(var_15.next).__qualname__}"
        == "linkedList5.Node"
    )
    assert (
        f"{type(var_16).__module__}.{type(var_16).__qualname__}" == "linkedList5.Node"
    )
    assert var_16.next is None
    assert (
        f"{type(var_16.data).__module__}.{type(var_16.data).__qualname__}"
        == "linkedList5.LinkedList"
    )
    ...
    assert (
        f"{type(var_18).__module__}.{type(var_18).__qualname__}" == "linkedList5.Node"
    )
