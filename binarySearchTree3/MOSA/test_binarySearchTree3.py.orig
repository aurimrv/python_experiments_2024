...
def test_case_5():
    ...
    assert (
        f"{type(var_3.tail).__module__}.{type(var_3.tail).__qualname__}"
        == "binarySearchTree3.NodeDLL"
    )
...
def test_case_34():
    ...
    module_0.DoubleLinkedList(double_linked_list_0)
