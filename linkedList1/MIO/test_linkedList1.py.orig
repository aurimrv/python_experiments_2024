...
def test_case_16():
    ...
    assert len(var_2) == 4
    assert len(var_4) == 4
    singly_linked_list_0.__getitem__(dict_0)
...
def test_case_27():
    ...
    var_0 = doubly_linked_list_0.append(int_0)
    assert len(doubly_linked_list_0) == 1
    doubly_linked_list_0.insert(int_0, int_0)
...
def test_case_28():
    ...
    var_3.__setitem__(var_2, bool_0)
...
def test_case_32():
    ...
    assert (
        f"{type(doubly_linked_node_0.data).__module__}.{type(doubly_linked_node_0.data).__qualname__}"
        == "linkedList1.DoublyLinkedList"
    )
