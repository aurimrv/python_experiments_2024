...
def test_case_7():
    ...
    assert len(doubly_linked_list_0) == 1
    assert len(var_0) == 1
    doubly_linked_list_0.insert(doubly_linked_list_0, int_0)
...
def test_case_11():
    ...
    var_2.__contains__(doubly_linked_list_0)
...
def test_case_26():
    ...
    assert len(doubly_linked_list_0) == 4
    assert len(var_2) == 4
    doubly_linked_list_0.__setitem__(var_2, doubly_linked_list_0)
