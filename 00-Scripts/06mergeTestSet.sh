...
then
	...
	echo "Example: mergeTestSet.sh /path DYNAMOSA MIO"
	echo "Example: mergeTestSet.sh /path DYNAMOSA MIO MOSA"
	echo "Example: mergeTestSet.sh /path DYNAMOSA MIO MOSA WHOLE_SUITE"
	exit
fi
