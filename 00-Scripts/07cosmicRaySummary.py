...
# Script for generating the mutant report spreadsheet for Cosmic Ray.
# Assumes that there is a TXT report file generated by the tool.
...
def main():
    if len(sys.argv) < 3:
        ...
        print("Example: cosmicRaySummary.py /path files.txt test-sets.txt")
        sys.exit(1)
...
def processingCosmicRayMetrics(prj, clazz, cosmicRayDir, output):
    clazz2 = clazz[:-3]
    db_filename = cosmicRayDir + "/"+clazz2+".sqlite"
