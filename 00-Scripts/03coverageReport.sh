...
then
   ...
   echo "Example: coverageReport.sh /path files.txt test-sets.txt"
...
# Iterating over the test-sets file
...
do
   ...
   do
      ...
      coverage run --omit="/home/name/.pyenv/*,*test_*" --branch -m pytest ./${testSet}/
      coverage report --omit="/home/name/.pyenv/*,*test_*" > ./${testSet}/coverage/covereageReport.txt
      coverage html --omit="/home/name/.pyenv/*,*test_*" -d ./${testSet}/coverage
      coverage xml --omit="/home/name/.pyenv/*,*test_*" -o ./${testSet}/coverage/covereageReport.xml
      coverage json --omit="/home/name/.pyenv/*,*test_*" -o ./${testSet}/coverage/covereageReport.json
