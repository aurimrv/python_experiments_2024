...
# Script for generating the mutant report spreadsheet for MutMut.
# Assumes that there is an HTML report file generated by the tool.
...
def main():
    if len(sys.argv) < 3:
        ...
        print("Example: mutmutSummary.py /path files.txt test-sets.txt")
        sys.exit(1)
